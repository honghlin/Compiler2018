...
public class LogicalAndChecker extends Visitor {

    private boolean f = true;

    private List<BinaryOpNode> whole = new ArrayList<>();
    ...
    public boolean check(BinaryOpNode node) {
       ...
       /* switch(node.operator()) {
        ...
        if(node instanceof LogicalAndNode || node instanceof LogicalOrNode) ;
        else whole.add(node);
        visitExpr(node.left());
    ...
    public List<BinaryOpNode> whole() { // get W
